...
//
    public synchronized void setData(ValutaModel valutaModel) {
        this.data = valutaModel;
    }

    public synchronized ValutaModel getData() {
        return data;
    }
